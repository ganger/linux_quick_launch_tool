...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Jul 29 19:37:50 2014
# Project:  linux_quick_launch_tool.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile linux_quick_launch_tool.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -I. -I/usr/local/Qxt/include/QxtCore -I/usr/local/Qxt/include/QxtGui
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lQtGui -lQtCore -lpthread -L/usr/lib -lQxtCore -lQxtGui
AR            = ar cqs
RANLIB        = 
...
Makefile: linux_quick_launch_tool.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile linux_quick_launch_tool.pro
